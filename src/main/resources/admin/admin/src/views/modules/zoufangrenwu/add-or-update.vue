<template>
  <div class="addEdit-block">
    ...
    >
      ...
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="任务目标" prop="renwumubiao">
          <el-input v-model="ruleForm.renwumubiao" 
              placeholder="任务目标" clearable  :readonly="ro.renwumubiao"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="任务目标" prop="renwumubiao">
              <el-input v-model="ruleForm.renwumubiao" 
                placeholder="任务目标" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
        <el-form-item class="date" v-if="type!='info'" label="任务日期" prop="renwuriqi">
            <el-date-picker
        ...
        <div v-else>
          <el-form-item class="input" v-if="ruleForm.renwuriqi" label="任务日期" prop="renwuriqi">
  ...
  methods: {
    ...
    init(id,type) {
      ...
      if(this.type=='info'||this.type=='else'){
	    ...
	    this.ro.renwudidian = true;
          ...
          if(o=='renwumubiao'){
            this.ruleForm.renwumubiao = obj[o];
	    this.ro.renwumubiao = true;
            continue;
          }
          if(o=='renwuneirong'){
    ...
    onSubmit() {
      ...
      this.$refs["ruleForm"].validate(valid => {
        if (valid) {
          this.$http({
            url: `zoufangrenwu/${!this.ruleForm.id ? "save" : "update"}`,
            method: "post",
            data: this.ruleForm
          }).then(({ data }) => {
            if (data && data.code === 0) {
              this.$message({
                ...
                onClose: () => {
                  ...
                  this.parent.zoufangrenwuCrossAddOrUpdateFlag = false;
                  this.parent.search();
