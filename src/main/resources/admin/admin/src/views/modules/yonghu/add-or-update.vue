<template>
  <div class="addEdit-block">
    ...
    >
      ...
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="生日" prop="shengri">
          <el-input v-model="ruleForm.shengri" 
              placeholder="生日" clearable  :readonly="ro.shengri"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="生日" prop="shengri">
              <el-input v-model="ruleForm.shengri" 
