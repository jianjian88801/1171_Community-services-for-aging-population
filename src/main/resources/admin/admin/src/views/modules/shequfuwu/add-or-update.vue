    ...
    >
      ...
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="服务地址" prop="fuwudizhi">
          <el-input v-model="ruleForm.fuwudizhi" 
              placeholder="服务地址" clearable  :readonly="ro.fuwudizhi"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="服务地址" prop="fuwudizhi">
              <el-input v-model="ruleForm.fuwudizhi" 
                placeholder="服务地址" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
