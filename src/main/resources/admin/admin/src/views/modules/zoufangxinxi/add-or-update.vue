<template>
  <div class="addEdit-block">
    ...
    >
      <el-row>
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="走访对象" prop="zoufangduixiang">
          <el-input v-model="ruleForm.zoufangduixiang" 
              placeholder="走访对象" clearable  :readonly="ro.zoufangduixiang"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="走访对象" prop="zoufangduixiang">
              <el-input v-model="ruleForm.zoufangduixiang" 
                placeholder="走访对象" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="走访地址" prop="zoufangdizhi">
          <el-input v-model="ruleForm.zoufangdizhi" 
              placeholder="走访地址" clearable  :readonly="ro.zoufangdizhi"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="走访地址" prop="zoufangdizhi">
              <el-input v-model="ruleForm.zoufangdizhi" 
                placeholder="走访地址" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
        <el-form-item class="date" v-if="type!='info'" label="走访日期" prop="zoufangriqi">
            <el-date-picker
                format="yyyy 年 MM 月 dd 日"
                value-format="yyyy-MM-dd"
                v-model="ruleForm.zoufangriqi" 
                type="date"
                placeholder="走访日期">
            </el-date-picker> 
        </el-form-item>
        <div v-else>
          <el-form-item class="input" v-if="ruleForm.zoufangriqi" label="走访日期" prop="zoufangriqi">
              <el-input v-model="ruleForm.zoufangriqi" 
                placeholder="走访日期" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="24">  
      ...
      <el-col :span="12">
        ...
        <div v-else>
          ...
          <el-row>
            <el-col :span="24">
              <el-form-item class="textarea" v-if="type!='info'" label="基本情况" prop="jibenqingkuang">
                <el-input
                  style="min-width: 200px; max-width: 600px;"
                  type="textarea"
                  :rows="8"
                  placeholder="基本情况"
                  v-model="ruleForm.jibenqingkuang" >
                </el-input>
              </el-form-item>
              <div v-else>
                <el-form-item v-if="ruleForm.jibenqingkuang" label="基本情况" prop="jibenqingkuang">
                    <span>{{ruleForm.jibenqingkuang}}</span>
                </el-form-item>
              </div>
            </el-col>
          </el-row>
          <el-row>
            <el-col :span="24">
              <el-form-item class="textarea" v-if="type!='info'" label="访问内容" prop="fangwenneirong">
                <el-input
                  style="min-width: 200px; max-width: 600px;"
                  type="textarea"
                  :rows="8"
                  placeholder="访问内容"
                  v-model="ruleForm.fangwenneirong" >
                </el-input>
              </el-form-item>
              <div v-else>
                <el-form-item v-if="ruleForm.fangwenneirong" label="访问内容" prop="fangwenneirong">
                    <span>{{ruleForm.fangwenneirong}}</span>
                </el-form-item>
              </div>
            </el-col>
          </el-row>
...
export default {
  data() {
    ...
    return {
      ...
      type: '',
      ro:{
	zoufangduixiang : false,
	zoufangdizhi : false,
	jibenqingkuang : false,
	fangwenneirong : false,
  ...
  methods: {
    ...
    init(id,type) {
      ...
      if(this.type=='info'||this.type=='else'){
        ...
        for (var o in obj){
          if(o=='zoufangduixiang'){
            this.ruleForm.zoufangduixiang = obj[o];
	    this.ro.zoufangduixiang = true;
            continue;
          }
          if(o=='zoufangdizhi'){
            this.ruleForm.zoufangdizhi = obj[o];
	    this.ro.zoufangdizhi = true;
            continue;
          }
          if(o=='jibenqingkuang'){
            this.ruleForm.jibenqingkuang = obj[o];
	    this.ro.jibenqingkuang = true;
            continue;
          }
          if(o=='fangwenneirong'){
            this.ruleForm.fangwenneirong = obj[o];
	    this.ro.fangwenneirong = true;
            continue;
          }
          if(o=='daijiejuewenti'){
	    ...
	    this.ro.beizhu = true;
          ...
          if(o=='zoufangriqi'){
            this.ruleForm.zoufangriqi = obj[o];
	    this.ro.zoufangriqi = true;
            continue;
          }
          if(o=='zhaopian'){
    ...
    onSubmit() {
      ...
      this.$refs["ruleForm"].validate(valid => {
        if (valid) {
          this.$http({
            url: `zoufangxinxi/${!this.ruleForm.id ? "save" : "update"}`,
            method: "post",
            data: this.ruleForm
          }).then(({ data }) => {
            if (data && data.code === 0) {
              this.$message({
                ...
                onClose: () => {
                  ...
                  this.parent.zoufangxinxiCrossAddOrUpdateFlag = false;
                  this.parent.search();
