<template>
  <div class="addEdit-block">
    ...
    >
      <el-row>
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'" label="文件编号" prop="wenjianbianhao">
            <el-input v-model="ruleForm.wenjianbianhao" 
                placeholder="文件编号" readonly></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" v-if="ruleForm.wenjianbianhao" label="文件编号" prop="wenjianbianhao">
              <el-input v-model="ruleForm.wenjianbianhao" 
                placeholder="文件编号" readonly></el-input>
          </el-form-item>
        </div>
      ...
      <el-col :span="24">  
        <el-form-item class="upload" v-if="type!='info'" label="文件下载" prop="wenjianxiazai">
          <file-upload
          tip="点击上传文件下载"
          action="file/upload"
          :limit="1"
          :multiple="true"
          :fileUrls="ruleForm.wenjianxiazai?ruleForm.wenjianxiazai:''"
          @change="wenjianxiazaiUploadChange"
          ></file-upload>
        </el-form-item>  
        <div v-else>
          <el-form-item v-if="ruleForm.wenjianxiazai" label="文件下载" prop="wenjianxiazai">
            <el-button type="text" size="small" @click="download(ruleForm.wenjianxiazai)">下载</el-button>
          </el-form-item>
        </div>    
      </el-col>      
      <el-col :span="12">
      ...
      <el-col :span="24">  
        ...
        <div v-else>
          ...
          <el-row>
            <el-col :span="24">
              <el-form-item v-if="type!='info'"  label="文件内容" prop="wenjianneirong">
                <editor 
              ...
              <div v-else>
                <el-form-item v-if="ruleForm.wenjianneirong" label="文件内容" prop="wenjianneirong">
                    <span v-html="ruleForm.wenjianneirong"></span>
                </el-form-item>
              </div>
            </el-col>
          </el-row>
  ...
  methods: {
    ...
    init(id,type) {
      ...
      if(this.type=='info'||this.type=='else'){
        ...
        for (var o in obj){
          if(o=='wenjianbianhao'){
            this.ruleForm.wenjianbianhao = obj[o];
	    this.ro.wenjianbianhao = true;
            continue;
          }
	    ...
	    this.ro.wenjianneirong = true;
          ...
          if(o=='wenjianxiazai'){
            this.ruleForm.wenjianxiazai = obj[o];
	    this.ro.wenjianxiazai = true;
            continue;
          }
          if(o=='faburen'){
	...
	this.ruleForm.wenjianneirong = this.ruleForm.wenjianneirong.replace(reg,'../../../springboot54r3f/upload');
        } else {
          this.$message.error(data.msg);
        }
      });
    ...
    onSubmit() {
      ...
      this.$refs["ruleForm"].validate(valid => {
        if (valid) {
          this.$http({
            url: `shequwenjian/${!this.ruleForm.id ? "save" : "update"}`,
            method: "post",
            data: this.ruleForm
          }).then(({ data }) => {
            if (data && data.code === 0) {
              this.$message({
                ...
                onClose: () => {
                  ...
                  this.parent.shequwenjianCrossAddOrUpdateFlag = false;
                  this.parent.search();
    ...
    wenjianxiazaiUploadChange(fileUrls) {
	this.ruleForm.wenjianxiazai = fileUrls;
			this.addEditUploadStyleChange()
    },
