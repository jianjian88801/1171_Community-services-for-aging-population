  ...
  <div>
    ...
    >  
     <el-row>
      ...
      <el-col :span="12">
        <el-form-item   v-if="flag=='yonghu'"  label="小区名称" prop="xiaoqumingcheng">
          <el-input v-model="ruleForm.xiaoqumingcheng"               placeholder="小区名称" clearable></el-input>
        </el-form-item>
      </el-col>
      <el-col :span="12">
        <el-form-item   v-if="flag=='yonghu'"  label="楼房号" prop="loufanghao">
      ...
      <el-col :span="12">
        <el-form-item   v-if="flag=='yonghu'"  label="生日" prop="shengri">
          <el-input v-model="ruleForm.shengri"               placeholder="生日" clearable></el-input>
        </el-form-item>
      </el-col>
      <el-col :span="24">  
      ...
      <el-col :span="12">
        <el-form-item   v-if="flag=='yuangong'"  label="小区名称" prop="xiaoqumingcheng">
          <el-input v-model="ruleForm.xiaoqumingcheng"               placeholder="小区名称" clearable></el-input>
        </el-form-item>
      </el-col>
      <el-col :span="12">
