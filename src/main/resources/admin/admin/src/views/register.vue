  ...
  <div>
    <div class="container">
      <div class="login-form" style="backgroundColor:rgba(255,255,255,.5);borderRadius:20px">
        <h1 class="h1" style="color:#000;fontSize:26px;">人口老龄化社区服务与管理平台注册</h1>
		<el-form ref="rgsForm" class="rgs-form" :model="rgsForm" label-width="120px">
			...
			<el-form-item label="小区名称" class="input" v-if="tableName=='yonghu'">
			...
			<el-form-item label="楼房号" class="input" v-if="tableName=='yonghu'">
			...
			<!-- <div v-if="tableName=='yonghu'" class="input-group">
			   ...
			   <div class="input-container">
			     <input v-model="ruleForm.shengri" class="input" type="text" placeholder="生日">
			   </div>
			 </div> -->
			<el-form-item label="生日" class="input" v-if="tableName=='yonghu'">
			  <el-input v-model="ruleForm.shengri" autocomplete="off" placeholder="生日"  />
			</el-form-item>
			...
			<el-form-item label="小区名称" class="input" v-if="tableName=='yuangong'">
			  <el-input v-model="ruleForm.xiaoqumingcheng" autocomplete="off" placeholder="小区名称"  />
			</el-form-item>
			<!-- <div v-if="tableName=='yuangong'" class="input-group">
...
<style lang="scss" scoped>
 ...
 //  }
	...
	.container {
		background-image: url("http://codegen.caihongy.cn/20210528/05f80abfe91d4343a281eced2578dc1a.jpg");
		height: 100vh;
